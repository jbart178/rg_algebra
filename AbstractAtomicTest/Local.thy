...
(* added and sorry-ed at the discretion of Larissa  should be moved to Guarantees.thy eventually *)
...
proof - 
  ...
  qed    
  also have a2: "... = (idle ; (local x . c) ; idle) \<iinter> guar (id(x))" 
    using guar_distrib_seq_eq by (metis local.conj_commute)
